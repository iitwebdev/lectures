...
from hreviewcollector.config.environment import load_environment
import hreviewcollector.lib.helpers
import hreviewcollector.lib.app_globals as app_globals
...
def make_app(global_conf, full_stack=True, **app_conf):
    ...
    config.init_app(global_conf, app_conf, package='hreviewcollector')
        
    # Load our default Pylons WSGI app and make g available
    app = pylons.wsgiapp.PylonsApp(config, helpers=hreviewcollector.lib.helpers,
